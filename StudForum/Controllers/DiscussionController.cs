...
namespace StudForum.Controllers
{
    ...
    public class DiscussionController : Controller
    {
        ...
        public DiscussionController(IDiscussionRepository rep, IUserRepository userRepository, ICategoryRepository categoryRepository)
        {
            _rep = rep;
        ...
        public async Task<IActionResult> Create(CreateDto dto)
        {
            try
            {
                Subcategory subcategory = await _categoryRep.GetBySubcategoryIdAsync(dto.SubcategoryId);
                var d = await _rep.AddAsync( new Models.Discussion(dto.Title, dto.Text, await _userRep.GetByIdAsync(dto.UserId), subcategory.Category, subcategory, dto.Hashtags));
